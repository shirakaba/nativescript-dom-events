...
export class DOMEvent implements Event {
  ...
  static {
    ...
    Object.defineProperty(DOMEvent.prototype, 'CAPTURING_PHASE', {
      value: DOMEvent.CAPTURING_PHASE,
    });
    Object.defineProperty(DOMEvent.prototype, 'AT_TARGET', {
      value: DOMEvent.AT_TARGET,
    });
    Object.defineProperty(DOMEvent.prototype, 'BUBBLING_PHASE', {
      value: DOMEvent.BUBBLING_PHASE,
    });
    Object.defineProperty(DOMEvent.prototype, 'cancelBubble', {
      value: false,
      writable: true,
    });
    Object.defineProperty(DOMEvent.prototype, 'defaultPrevented', {
      value: false,
      writable: true,
    });
    Object.defineProperty(DOMEvent.prototype, 'isTrusted', {
      value: false,
      writable: true,
      enumerable: true,
    });
    Object.defineProperty(DOMEvent.prototype, 'eventPhase', {
      value: DOMEvent.NONE,
      writable: true,
    });
    Object.defineProperty(DOMEvent.prototype, 'currentTarget', {
      value: null,
      writable: true,
    });
    Object.defineProperty(DOMEvent.prototype, 'target', {
      value: null,
      writable: true,
    });
    Object.defineProperty(DOMEvent.prototype, 'propagationState', {
  ...
  dispatchTo(
    ...
    getGlobalEventHandlers?: (
      data: EventData,
      eventType: 'First' | ''
    ) => readonly ListenerEntry[] | undefined
  ): boolean {
    ...
    const removeGlobalEventListener = (
      target.constructor as unknown as typeof target
    ).removeEventListener as Observable['removeEventListener'];
    ...
    this.handleEvent(
      data,
      true,
      () => getGlobalEventHandlers?.(data, 'First') ?? emptyArray,
      DOMEvent.CAPTURING_PHASE,
    ...
    for (let i = 0; i < eventPath.length; i++) {
      ...
      this.handleEvent(
        data,
        false,
        () => currentTarget._getEventList(this.type) ?? emptyArray,
        DOMEvent.CAPTURING_PHASE,
    ...
    this.handleEvent(
      data,
      true,
      () => getGlobalEventHandlers?.(data, '') ?? emptyArray,
      DOMEvent.BUBBLING_PHASE,
      removeGlobalEventListener,
      target.constructor
    );
  ...
  private handleEvent(
    ...
    for (let i = listeners.length - 1; i >= 0; i--) {
      ...
      if (
        !isGlobal &&
        ((phase === DOMEvent.CAPTURING_PHASE && !capture) ||
          (phase === DOMEvent.BUBBLING_PHASE && capture))
      ) {
        continue;
      }
